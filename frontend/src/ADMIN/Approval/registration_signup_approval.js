                              ...
                              <Container>
                                    {ApprovalData && ApprovalData.map((data)=>(
                                          <div>
                                                ...
                                                {buttonClicked &&(data.type==="registration")&& <Accordion>
                                                            ...
                                                            <Typography>
                                                                  ...
                                                                  
                                                                  {
                                                                        (data.status === "false") ? <Row style={{ width: "65%", margin: "0px auto" }}>
                                                                              <Col><button className="btn btn-success questionTypeButtons">ACCEPT</button></Col>
                                                                              <Col><button className="btn btn-danger questionTypeButtons">REJECT</button></Col>
                                                                        </Row> : 
                                                ...
                                                {/* SIGN UP APPROVAL */}
                                                {!buttonClicked && (data.type === "signup") && <Accordion>
                                                      <AccordionSummary
                                                            expandIcon={<ExpandMoreIcon />}
                                                            aria-controls="panel1a-content"
                                                            id="panel1a-header"
