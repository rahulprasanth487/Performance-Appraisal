...
import { Typography, AppBar, Toolbar, TextField, Button, Stack, Snackbar, Box, Dialog, ListItemText, ListItem, List, Divider, IconButton, Slide, InputLabel, FormControl, Select, formControlClasses } from "@mui/material";
...
const UserPaperInConferences = (props) => {
      useEffect(() => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/paper_publications_in_conferences", {
      ...
      const handleAdd = async (e) => {
            if (formContent.title == ""||formContent.conference == "" || formContent.national_international == "" || formContent.organising_agency == "" || formContent.date_of_conf == "") {
                  ...
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        ...
                        if (formContent.national_international == "national") {
                              formContent.marks = "1"
                        }
                        else if (formContent.national_international == "international") {
                              formContent.marks = "2"
                        }
                        else {
                              formContent.marks = "0"
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/paper_publications_in_conferences", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
      ...
      const [marks_details, setMarksDetails] = useState(
            {
                  ...
                  "name": "",
                  "email": "",
                  "table_name": "paper_publications_in_conferences",
                  "max_marks": "15"
            }
      )
                  ...
                  <Navbar />
                  {
                        data && <>
                              <div style={{ display: "flex" }}>
                                    ...
                                    <Container>
                                          <hr />
                                          <center><h1>PAPER PUBLICATIONS IN CONFERENCES</h1></center>
                                          {/* <h2>CREDITS : {marks} </h2> */}
                                          <hr />
                                          <>
                                                      ...
                                                      <table className="table table-bordered table-striped">
                                                            <thead className="thead-dark">
                                                                  <tr>
                                                                        ...
                                                                        <th scope="col">Date of the Conference</th>
                                                                  </tr>
                                                            </thead>
                                                            <tbody>
                                                            ...
                                                            <List>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              ...
                                                                              label="TITLE"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.title = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              label="CONFERENCE"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.conference = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="text"
                                                                              label="ORGANISING AGENCY"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.organising_agency = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <FormControl fullWidth style={{ marginLeft: "5px" }}>
                                                                              <InputLabel id="demo-simple-select-required-label">NATIONAL/INTERNATIONAL</InputLabel>
                                                                              <Select
                                                                                    labelId="demo-simple-select-required-label"
                                                                                    id="demo-simple-select-required"
                                                                                    label="NATIONAL/INTERNATIONAL"
                                                                                    onChange={(e) => { formContent.national_international = e.target.value }}
                                                                              >
                                                                        ...
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="text"
                                                                              label="DATE OF CONFERENCE (dd/mm/yyyy"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.date_of_conf = e.target.value }}
                                                                        />
                                                                        <br />
...
export default UserPaperInConferences;