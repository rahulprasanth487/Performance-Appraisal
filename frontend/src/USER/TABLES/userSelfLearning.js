...
const UserSelfLearning = (props) => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/self_learning", {
      ...
      const handleAdd = async (e) => {
            if (formContent.Course === "" || formContent.Institution === "" || formContent.Duration === "" || formContent.Credits === "") {
                  ...
                  if (formContent.Institution === "NPTEL"){formContent.marks = "5"}
                  else if (formContent.Institution === "FDP"){
                        alert("Hello")
                        formContent.marks = "2"
                  }
                  else
                  {
                        formContent.marks = formContent.Credits;
                  }
                  ...
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/self_learning", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
                  ...
                  <Navbar />
                  {
                        data && <>
                              <div style={{ display: "flex" }}>
                                    ...
                                    <Container>
                                          <hr />
                                          <center><h1>SELF LEARNING</h1></center>
                                          <hr />
                                                      ...
                                                      >
                                                            ...
                                                            <List>
                                                                  <center>
                                                                        ...
                                                                        <Typography variant="h5">(Note:NPTEL have 5 credits and FDP have 2 credits)</Typography>
                                                                  </center>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              ...
                                                                              label="Course Name"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.Course = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="text"
                                                                              label="Institution (like NPTEL,FDP)"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.Institution = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              label="Duration"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.Duration = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              label="Credits"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.Credits = e.target.value }}
                                                                        />
                                                                        <br />
...
export default UserSelfLearning;