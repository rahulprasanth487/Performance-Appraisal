...
const UserTeachingWorkload = (props) => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year=yr;
            fetch("http://localhost:4000/api/user/data/teaching_workload",{
      ...
      var marks = TableData && ((TableData).reduce((total, currItem) => total = total + parseInt(currItem.credits),0));
      ...
      const handleAdd=async (e)=>{
            if(formContent.semester == ""||formContent.branch == ""||formContent.subject == "" || formContent.credits==""||formContent.year ==""||formContent.total_students=="")
            {
                  ...
                  if(window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit"))
                  {
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/teaching_workload", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
                                                            ...
                                                            <List>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              ...
                                                                              label="SEMESTER"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.semester = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                        ...
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="number"
                                                                              label="TOTAL STUDENTS IN THE SUBJECT"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.total_students = e.target.value }}
                                                                        />
                                                                        <br />
