...
const UserProjectGuidance = (props) => {
      useEffect(() => {
      ...
      const fetchDataWithFilter = async (yr) => {
            setYear(yr)
            const obj = {}
            obj.name = data[0].name_staff;
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/project_guidance", {
      ...
      const handleAdd = async (e) => {
            if (formContent.semester == "" || formContent.innovation_adopted == "" || formContent.subject == "") {
                  ...
                  formContent.name_staff = data[0].name
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        setOpen(false);

                        
                        if (formContent.UG_PG === "UG"){formContent.marks = "2";}
                        else {formContent.marks = "3";}

                        await fetch("http://localhost:4000/api/user/pushData/project_guidance", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
      ...
      const handleMarkDetails = async () => {
            ...
            await fetch("http://localhost:4000/api/user/pushData/marks_details3/", {
                  method: "PATCH",
                  headers: {
                        "Content-Type": "application/json",
                  },
                  ...
                  <Navbar />
                  {
                        data && <>
                              <div style={{ display: "flex" }}>
                                    ...
                                    <Container>
                                          <hr />
                                          <center><h1>PROJECT GUIDANCE</h1></center>
                                          <hr />
                                          {/* <h2>CREDITS : {marks} </h2> */}
                                          <>
                                                      ...
                                                      >
                                                            ...
                                                            <List>
                                                                  <center>
                                                                        ...
                                                                        <Typography variant="h5">(Note:In previous 2 years only)</Typography>
                                                                  </center>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              ...
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.name_student = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              label="UG/PG"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent["UG_PG"] = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
...
export default UserProjectGuidance;