...
const UserAwards = (props) => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/awards", {
      ...
      const handleAdd = async (e) => {
            if (formContent.name_of_honour == ""||formContent.details_of_award == ""||formContent.date == ""||formContent.national_international == "") {
                  ...
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/awards", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
                                                      ...
                                                      <table className="table table-bordered table-striped">
                                                            <thead className="thead-dark">
                                                                  <tr>
                                                                        ...
                                                                        <th scope="col">Details of the Award</th>
                                                                        <th scope="col">Date</th>
                                                                        <th scope="col">National/International</th>                                                                  </tr>
                                                            </thead>
                                                            <tbody>
                                                            ...
                                                            <List>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="text"
                                                                              label="NAME OF THE HONOUR"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.name_of_honour = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.details_of_award = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              label="DATE"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.date = e.target.value }}
                                                                        />
                                                                        <br />
