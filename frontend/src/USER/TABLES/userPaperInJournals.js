...
const UserPaperInJournals = (props) => {
      useEffect(() => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/paper_publications_in_journals", {
      ...
      const handleAdd = async (e) => {
            if (formContent.title == ""||formContent.journal_name == ""||formContent.publisher == ""||formContent.quartile == ""||formContent.reference=="") {
                  ...
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        ...
                        if(formContent.quartile == "Q1"){
                              formContent.marks = "5"
                        }
                        else if(formContent.quartile == "Q2"){
                              formContent.marks = "3"
                        }
                        else if(formContent.quartile == "Q3"){
                              formContent.marks = "2"
                        }
                        else if(formContent.quartile == "Q4"){
                              formContent.marks = "1"
                        }
                        else{
                              formContent.marks = "0"
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/paper_publications_in_journals", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
      ...
      const [marks_details, setMarksDetails] = useState(
            {
                  ...
                  "name": "",
                  "email": "",
                  "table_name": "paper_publications_in_journals",
                  "max_marks": "20"
            }
      )
                  ...
                  <Navbar />
                  {
                        data && <>
                              <div style={{ display: "flex" }}>
                                    ...
                                    <Container>
                                          <hr />
                                          <center><h1>PAPER PUBLICATIONS IN JOURNALS</h1></center>
                                          <hr />
                                          {/* <h2>CREDITS : {marks} </h2> */}
                                          <>
                                                            ...
                                                            <List>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              ...
                                                                              label="JOURNAL NAME"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.journal_name = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              ...
                                                                              label="PUBLISHER"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.publisher = e.target.value }}
                                                                        />
                                                                        <br />
                                                                        <FormControl fullWidth style={{marginLeft:"5px"}}>
                                                                              <InputLabel id="demo-simple-select-required-label">QUARTILE</InputLabel>
                                                                              <Select
                                                                                    labelId="demo-simple-select-required-label"
                                                                                    id="demo-simple-select-required"
                                                                                    label="QUARTILE"
                                                                                    onChange={(e)=>{formContent.quartile=e.target.value}}
                                                                              >
                                                                        ...
                                                                        <TextField
                                                                              ...
                                                                              label="REFERENCE)"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.reference = e.target.value }}
                                                                        />
                                                                        <br />
...
export default UserPaperInJournals;