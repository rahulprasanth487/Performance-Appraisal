...
const UserContributionInstitution = (props) => {
      useEffect(() => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/contribution_to_institutions", {
      ...
      const handleAdd = async (e) => {
            if (formContent.details == "" || formContent.dept_clg_univ == "" || formContent.type == "" || formContent.period == "") {
                  ...
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/contribution_to_institutions", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
      ...
      const [marks_details, setMarksDetails] = useState(
            {
                  ...
                  "name": "",
                  "email": "",
                  "table_name": "contribution_to_institutions",
                  "max_marks": "10"
            }
      )
                  ...
                  <Navbar />
                  {
                        data && <>
                              <div style={{ display: "flex" }}>
                                    ...
                                    <Container>
                                          <hr />
                                          <center><h1>CONTRIBUTION TO INSTITUTION</h1></center>
                                          <hr />
                                          {/* <h2>CREDITS : {marks} </h2> */}
                                          <>
                                                            ...
                                                            <List>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="text"
                                                                              label="TYPE OF THE ACTIVITY (NSS/YRC/NSO/...)"
                                                                              variant="outlined"
...
export default UserContributionInstitution;