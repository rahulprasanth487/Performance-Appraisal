...
const UserTeachingLearningPractices = (props) => {
      useEffect(() => {
      ...
      const fetchDataWithFilter = async (yr) => {
            ...
            obj.year = yr;
            fetch("http://localhost:4000/api/user/data/teaching_learning_practices", {
      ...
      const handleAdd = async (e) => {
            if(formContent.semester == ""||formContent.innovation_adopted == ""||formContent.subject == "")
            {
                  ...
                  if (window.confirm("CHECK THE DETAILS:\nOK to submit\nCANCEL to edit")) {
                        ...
                        await fetch("http://localhost:4000/api/user/pushData/teaching_learning_practices", {
                              method: "POST",
                              headers: {
                                    "Content-Type": "application/json",
                              },
                  ...
                  <Navbar />
                  {
                        data && <>
                              <div style={{ display: "flex" }}>
                                    ...
                                    <Container>
                                          <hr />
                                          <center><h1>TEACHING LEARNING PRACTICES</h1></center>
                                          <hr/>
                                          {/* <h2>CREDITS : {marks} </h2> */}
                                          <>
                                                            ...
                                                            <List>
                                                                  ...
                                                                  <form>
                                                                        ...
                                                                        <TextField
                                                                              style={{ width: "100%", margin: "5px" }}
                                                                              type="text"
                                                                              label="INNOVATION ADOPTED"
                                                                              variant="outlined"
                                                                              onInput={(e) => { formContent.innovation_adopted = e.target.value }}
                                                                        />
                                                                        <br />
...
export default UserTeachingLearningPractices;